...
const firebaseConfig = {
  apiKey: "AIzaSyBExTVuBbYjWspgFh47ZrmYGr9OiJn_3Qo",
  authDomain: "fyp-ar-tour.firebaseapp.com",
  projectId: "fyp-ar-tour",
  storageBucket: "fyp-ar-tour.appspot.com",
  messagingSenderId: "1002765438945",
  appId: "1:1002765438945:web:97fe581990b5288d818ca0",
  measurementId: "G-RK1PP484T9",
};
  ...
  requestDataFromServer: function requestDataFromServerFn(lat, lon) {
    ...
    db.collection('diy_places').get().then((querySnapshot) => {
      ...
      querySnapshot.forEach((doc) => {
        ...
        jsonlist.push(JSON.parse(JSON.stringify(doc.data())));
      });
      console.log(jsonlist.length);
      World.loadPoisFromJsonData(jsonlist);
    }).catch((err) => {
      World.updateStatusMessage("Invalid web-service response. " + err, true);

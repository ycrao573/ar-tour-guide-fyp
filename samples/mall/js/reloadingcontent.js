...
var World = {
  ...
  loadPoisFromJsonData: function loadPoisFromJsonDataFn(poiData) {
    ...
    for (
      ...
      World.markerDrawableImage = new AR.ImageResource(
        "https://cdn-icons-png.flaticon.com/512/469/469962.png",
        {
          onError: World.onError,
        }
      );
  ...
  onMarkerSelected: function onMarkerSelectedFn(marker) {
    ...
    document.getElementById("poiDetailImage").src =
      ...
      ",Singapore&markers=" +
      marker.poiData.title +
      ",Singapore&zoom=14&size=400x400&key=AIzaSyCcuOYBEHg6xRvC-NU-ScSPH01aDndnV_w";
  ...
  requestDataFromServer: function requestDataFromServerFn(lat, lon) {
    ...
    xhr.open(
      "GET",
      "https://api.jsonbin.io/v3/b/61d732af2675917a628b693c/latest",
      true
    );
